...
$(function () {
  ...
  Quagga.onDetected(function (result) {
    ...
    $.get("/apiservice/?gtin=" + result.codeResult.code, function(data) {
      ...
      // var textnode = document.createTextNode('Description: ' + data.products[0].description);
      ...
      nameField.val(data.products[0].brand);
      descriptionField.val(data.products[0].description);
